...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 17:05:00 2020

@author: hamishgibbs

Convert ethnicity to tiles
Would have been better to clean the data first, then extract to tiles (lots of reused code here)
"""
...
if not hasattr(main, '__file__'):
    argv = ['code', '/Users/hamishgibbs/Documents/Covid-19/facebook_mobility_uk/data/processed/tile_reference/tiles_zoom_12.shp',
            ...
            '/Users/hamishgibbs/Documents/Covid-19/facebook_mobility_uk/data/raw/Ethnicity_Data/bulk.csv',
            '/Users/hamishgibbs/Documents/Covid-19/facebook_mobility_uk/data/raw/Ethnicity_Data/KS201SC.csv',
            '/Users/hamishgibbs/Documents/Covid-19/facebook_mobility_uk/data/raw/Ethnicity_Data/DT201NI (s).csv',
...
'''
Make wild tree plots from "cliques" online
Paper on time clusters https://link.springer.com/article/10.1007/s41109-018-0090-3#ref-CR36
'''
