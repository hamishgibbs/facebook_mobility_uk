...
# -*- coding: utf-8 -*-
"""
Created on Sat Oct 17 14:52:21 2020

@author: hamishgibbs

Script to extract communities from Facebook movement using Leiden algorithm.
...
from community_detection import communities_lei, extract_communities_date
...
if not hasattr(main, '__file__'):
    argv = ['code', '/Users/hamishgibbs/Documents/Covid-19/facebook_mobility_uk/data/interim/mobility_days.csv',
            ...
            '/Users/hamishgibbs/Documents/Covid-19/facebook_mobility_uk/data/processed/infomap/leiden_full.csv']
else:
    argv = sys.argv
...
lei = extract_communities_date(mob, communities_lei, silent = False)
